...
func newQueueManagerMetrics(r prometheus.Registerer, rn, e string) *queueManagerMetrics {
	...
	bytesSentCounterVec := prometheus.NewCounterVec(prometheus.CounterOpts{
		Namespace:   namespace,
		Subsystem:   subsystem,
	...
	m.bytesSent = bytesSentCounterVec.WithLabelValues(samples)
	m.metadataBytesSent = bytesSentCounterVec.WithLabelValues(metadata)
